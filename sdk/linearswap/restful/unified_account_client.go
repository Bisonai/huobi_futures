...
func NewUnifiedAccountClient(accessKey string, secretKey string, host string) *UnifiedAccountClient {
	return new(UnifiedAccountClient).Init(accessKey, secretKey, host)
}
